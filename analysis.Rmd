...
The following code tests which potential independent variables are associated with binary gender. Sample size was insufficient to include non-binary individuals in this analysis. These comparisons were not preplanned, but run to contextualize differences in behavior.
```{r}
